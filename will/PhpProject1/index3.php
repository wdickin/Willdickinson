...
#$dbh=mysql_connect ("box1007.bluehost.com", "willdic1_will", "oxaHP2JI2Ifo")
$dbh=mysql_connect ("localhost", "willdic1_will", "oxaHP2JI2Ifo")
or die ('I cannot connect to the database.');
mysql_select_db ("willdic1_exp");

$servername = "localhost";
$username = "willdic1_will";
$password = "oxaHP2JI2Ifo";
$dbname = "willdic1_exp";
...
$sql = "SELECT id, transact FROM ex";
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
         echo  "</td><td>" . $row["id"]. " " . $row["transact"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
